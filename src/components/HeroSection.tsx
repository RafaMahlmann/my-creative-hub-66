    ...
    <section
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          className="font-body text-lg md:text-xl text-muted-foreground max-w-xl mx-auto leading-relaxed mb-10 text-center">Fundador e Curador do Ecosistema Flor de Plasma                                 Terapeuta de Campo
